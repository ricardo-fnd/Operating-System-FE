...
const Guest = ({ onClick }: GuestCard) => {
  ...
  return (
    <>
      <div id={tooltipId} className={StyledContainer}>
        <GuestIcon />
        <p className={StyledText}>
          {getLabel("welcome-screen.guest.title")}
        </p>
      </div>
      <Tooltip
        noArrow
